(function (exports, browser) {
    ...
    /**
      * @class Assets
     */
    Assets = new Class("RadamnAssets",/** @lends Assets.prototype */{
        /**
         * @member Assets
         * @type Hash
         */
    ...
    Assets.Implements({
        ...
        __getImage: function (path, zip_file, generate_mask) {
            ...
            console.log("# loading: ", Radamn.get("root") + path);
        ...
        __getSound: function (path) {
            Radamn.debug("load:audio - from file: ", arguments);
            console.log("# loading ", path);

            var audio = null;

            if ((audio = this.__audios.get(path)) !== null) {
                return audio;
            }
            ...
            audio.src = Radamn.get("root") + path;

            this.__images.set(path, audio);
        ...
        getSound: function (path, zip_file) {
            return new Radamn.Audio({element: this.__getSound(path)});
        },
        /**
