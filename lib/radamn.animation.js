(function(exports, browser) {
     ...
     * @extends Image
     */
    var Animation = new Class("RadamnAnimation",
    ...
    Animation.implements({
        ...
        play: function(loop_or_times) {
            if(loop_or_times === true) { this.__remaining_times = false; this.loop = true;}
            else if(loop_or_times === false) { this.__remaining_times = false; this.loop = false;}
            ...
            */
            ...
            if(this.__actumulated_time > this.__rotation_delay) {
                ...
                if(this.__frame >= this.animation.length) {
                    this.__frame = 0;
                    if(this.loop === false) this.isStop = true;
