(function (exports, browser) {
    ...
    var Class = browser ? NodeClass.Class : require("node-class").Class,
        ...
        ObjectMerge = browser ? NodeClass.ObjectMerge : require("node-class").ObjectMerge,
    ...
    /** @lends Camera.prototype */
    {
        ...
        translate: function (x, y, options) {
            this.__root.setAnimationLink(Animate.CHAIN);

            var r = this.__root.animate(ObjectMerge(options || {}, {
