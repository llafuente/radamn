(function (exports, browser) {
    ...
    CanvasRenderingContext2D.implements({
        ...
        moveTo: function (x, y) {
            ...
            //__verbose("moveTo", this.__current_position);
        },
        ...
        __get_current_position: function (if_not_set) {
            //__verbose("__get_current_position", this.__current_position);
    ...
    CanvasRenderingContext2D.property("fillStyle",
    function() {
    ...
    CanvasRenderingContext2D.property("strokeStyle",
    function() {
    ...
    CanvasRenderingContext2D.property("font",
    function() {
        return this.__font;
    },
    function (font) {
        ...
        current_font_ptr = Radamn.Assets.__getFont(path.normalize(this.__fonts[font[1]]), font[0]);
