(function (exports, browser) {
    ...
    var Class = browser ? NodeClass.Class: require("node-class").Class,
        ...
        ObjectEach = browser ? Object.each: require("node-class").ObjectEach,
    ...
    Node.Implements({
        ...
        //
        _applyTransform: function(ctx) {
            this.matrix.applyTransform(ctx);
        ...
        getDerivedPosition: function (include_root) {
            ...
            out = new Vec2(0, 0);
            do {
                out = out.add(node.matrix.getPosition());
        ...
        */
        ...
        collide: function (operand) {
            ...
            return Math.intersection(this.__body[0].clone().translate(this.getDerivedPosition()), operand);
        },
        /**
         * Get all entities recursive from this node and his children
         *
