...
/** @lends TMXIsometric.prototype */
{
    ...
    getScreenPosition : function(x,y,z) {
        return {x: ((x - y) * this.tileset.iwidth), // [-4608, 4608]
            y: ((y + x) * this.tileset.iheight),  // [    0, 4608]
            z: 0
        };
    },
    /**
...
/** @lends TMXOrtogonal.prototype */
{
    ...
    getScreenPosition: function(x,y,z) {
        return {
            x: (x * this.tileset.iwidth), // [-4608, 4608]
            y: (y * this.tileset.iheight),  // [    0, 4608]
            z: 0
        };
    },
    /**
...
/** @lends TMX.prototype */
{
    ...
    name : "TMX",
    /**
     * <pre>contains the folowing structure
     * {
     *     tile_data: []
    ...
    __setXML: function(xml) {
        ...
        xml.children.each(function(nodeEL) {
            ...
            case "tileset" :
				...
				// XXX HACK!
                this.tilesets.push(Radamn.Assets.getImage("./resources/images/"+image_URL));
