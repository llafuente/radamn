...
(function (exports, browser) {
    ...
    var Class = browser ? NodeClass.Class : require("node-class").Class,
        ...
        __warning = browser ? NodeClass.warn : require("node-class").warn,
            ...
            for (; i < max; ++i) {
                ...
                for (; j < jmax; ++j) {
                    ...
                    if (tile[0].surface.__ready) {
                        ctx.drawImage(tile[0].surface || tile[0].surface, tile[1], tile[2], tile[3], tile[4], tile[5], tile[6], tile[7], tile[8]);
                    }
