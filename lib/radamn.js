...
(function (exports, browser) {
    ...
    if (!browser) {
        ...
        if (global.CRadamn === undefined) {
            try {
                ...
                exports.CRadamn = global.CRadamn = {
                    time: function () { return +(new Date()); },
                    getVersion: function () { return "test-mode"; },
                    init: function () {},
                    GL : {
                        flipBuffers: function () {}
                    },
                    pollEvent: function () { return false; }
                };
                Radamn.warning("# c-radamn not found. so you cannot create a window.");
            }
    ...
    Radamn.Implements(/** @lends Radamn.prototype */{
        ...
        __renderLoop: function () {
            ...
            for (i = 0; i < this.__windows.length; ++i) {
                win = this.__windows[i];
                ctx = win.getContext();
