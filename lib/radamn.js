...
var Radamn = global.Radamn = new Class({
     ...
     * @returns {Object}
     */
    getVersion: CRadamn.getVersion, /*function() {
...
Radamn.Font = new Class({
     ...
     * @returns {Boolean}
     */
    write: function(ctx, text, color, x, y) {
...
Radamn.Canvas = new Class({
	...
	/**
	 *  @returns Object {width: X}
	 */
	measureText: function(text) {
		var font = this.__parseFont();

		font.measureText(text, this.fillStyle, x, y);
	},
    __paths: [],
    /**
     * references:
