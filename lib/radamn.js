...
(function (exports, browser) {
    ...
    /** @lends Radamn.prototype */
    {
        ...
        createWindow: function(internal_width, internal_height, width, height) {
            ...
            console.log(exports.Radamn);

            var win = new exports.Radamn.Window(canvas, width, height);
        ...
        start: function(delay) {
            ...
            if(DomWindow.requestAnimationFrame) {
                wrap_fn = function() {
                    DomWindow.requestAnimationFrame(wrap_fn);
                    render_fn();
                };
                DomWindow.requestAnimationFrame(wrap_fn);
            } else {
        ...
        stop: function() {
            if(DomWindow.requestAnimationFrame) {
                DomWindow.cancelAnimationFrame(this.intervals.render);
            } else {
