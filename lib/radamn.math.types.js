 ...
 * @class Vec2
 */
var Vec2 = exports.Vec2 = new Type('Vec2', function(object){
 ...
 * @class Line2
 */
var Line2 = exports.Line2 = new Type('Line2', function(object){
 ...
 * @class Segment2
 */
var Segment2 = exports.Segment2 = new Type('Segment2', function(){
    var object = null;
 ...
 * @class Circle
 */
var Circle = exports.Circle = new Type('Circle', function(object){
    if(arguments.length == 2) {
        this.set(arguments[0], arguments[1]);
    }
    else if(arguments.length == 1) {
 ...
 * @class Rectangle
 */
var Rectangle = exports.Rectangle = new Type('Rectangle', function(){
    var object = null;
 ...
 * @class Polygon
 */
var Polygon = exports.Polygon = new Type('Polygon', function(object){
	this.initialize();
 ...
 * @class Matrix2D
 */
var Matrix2D = exports.Matrix2D = new Type('Matrix2D', function(object){
