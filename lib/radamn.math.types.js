 ...
 * @class Vec2
 */
var Vec2 = exports.Vec2 = new Class("Vec2", {
    /**
     * @member Vec2
     * @type Number
     */
...
Vec2.implements({
    __construct: function(){
        if(arguments.length == 2) {
            ...
            // <debug>
            if (["Vec2", "object"].indexOf(typeOf(object)) === -1) {
 ...
 * @class Line2
 */
var Line2 = exports.Line2 = new Class("Line2", {
    x : 0,
    y : 0,
    m : 0,
});
...
Line2.implements({
    __construct: function(object) {
        if(arguments.length == 4) {
            ...
            // <debug>
            if (["Line2", "object"].indexOf(typeOf(object)) === -1) {
                throw new Error("how can i init this!?");
            }
            // </debug>
 ...
 * @class Segment2
 */
var Segment2 = exports.Segment2 = new Class("Segment2", {
    x1 : 0,
    y1 : 0,
    x2 : 0,
    y2 : 0,
...
Segment2.implements({
    __construct: function(object){
        if(arguments.length == 4) {
            ...
            if (["Segment2", "object"].indexOf(typeOf(object)) === -1) {
                throw new Error("how can i init this!?");
            }
            this.x1 = object.x1;
            this.y1 = object.y1;
 ...
 * @class Circle
 */
var Circle = exports.Circle = new Class("Circle", {
    c: null,
    r: 0,
});
 ...
 * @class Rectangle
 */
var Rectangle = exports.Rectangle = new Class("Rectangle", {
    v1 : 0,
    v2 : 0,
    dirty : true,
});
