    ...
    Movable.Implements({
        ...
        chase: function (enable, movable, offset, options) {
            if (!enable) {
                ...
                this.chase_step = chase(movable.getDerivedPosition(false),  this.getPosition(), options); // options not used atm!
        ...
        tick: function (delta) {
            ...
            if (this.chase_step) {
                this.chase_step.set_leader(this.chase_movable.getDerivedPosition(false));
