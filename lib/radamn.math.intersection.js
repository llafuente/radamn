(function (exports, browser) {
     ...
     *
     */
    intersection_rectangle_vs_vec2 = Math.intersection_rectangle_vs_vec2 = function (rectangle, vec2, distance) {
        ...
        if (
            ...
            return {success: false, reason: "outside", distance: distance ? Math.distance_rectangle_vs_vec2(rectangle, vec2) : null};
        }
        ...
        if (
            ...
            return {success: true, reason: "collide", points: [vec2], distance: 0};
        }

        return {success: false, reason: "inside", distance: distance ? Math.distance_rectangle_vs_vec2(rectangle, vec2) : null};
    };
    /**
     * @member Math
