(function (exports, browser) {
    ...
    Matrix2D.Implements({
        ...
        skewX : function (angle) {
            ...
            this.__skewx += angle;
            this.multiply(Matrix2D.skewXMatrix(angle).p);
        ...
        skewY : function (angle) {
            ...
            this.__skewy += angle;
            this.multiply(Matrix2D.skewYMatrix(angle).p);
         ...
         * @returns Matrix2D this for chaining
         */
        applyTransform : function (ctx, exclude_translation) {
            __debug("applyTransform", this.p);
            var p = this.p;

            ctx.transform(p[0], p[1], p[2], p[3], exclude_translation ? 0 : p[4], exclude_translation ? 0 : p[5]);
    ...
    Matrix2D.hide(["__scalex", "__scaley", "__skewx", "__skewy", "__rotation"]);
