(function (exports, browser) {
    ...
    Vec2.implements({
        ...
        equals: function (v2) {
            // <debug>
            assert.equal(typeOf(v2), "Vec2", "a is not a Vec2");
            // </debug>
        ...
        */
        ...
        dot : function (v2) {
            // <debug>
            assert.equal(typeOf(v2), "Vec2", "Vec2::dot, v2 is not a Vec2");
            // </debug>
        ...
        */
         ...
         */
        divide : function (b) {
            assert.equal(typeOf(b), "Vec2", "b is not a Vec2");
         ...
         */
        min : function (b) {
            assert.equal(typeOf(b), "Vec2", "Vec2::min, b is not a Vec2");
         ...
         */
        max : function (b) {
            assert.equal(typeOf(b), "Vec2", "Vec2::max, b is not a Vec2");
