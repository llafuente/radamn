(function (exports, browser) {
    ...
    var Class = browser ? NodeClass.Class : require("node-class").Class,
        ...
        __dtypeof = browser ? NodeClass.Typeof : require("node-class").Typeof,
    ...
    __assert_arg = __dtypeof = function() {};
    ...
    Vec2.Implements({
        __construct: function (x, y) {
            if (arguments.length === 2) {
                ...
                // </debug>
                this.x = parseFloat(x.x, 10);
                this.y = parseFloat(x.y, 10);
            }
        },
        /**
         * set xy values
        ...
        equals: function (v2) {
            // <debug>
            assert.equal(__dtypeof(v2), "Vec2", "a is not a Vec2");
            // </debug>
        ...
        */
        ...
        subtract : function (a, b) {
            if (arguments.length === 1) {
                // <debug>
                assert.equal(__dtypeof(a), "Vec2", "a is not a Vec2");
                // </debug>
                ...
                // <debug>
                assert.equal(__dtypeof(a), "number", "a is not a Number");
                assert.equal(__dtypeof(b), "number", "b is not a Number");
                // </debug>
        ...
        dot : function (v2) {
            // <debug>
            assert.equal(__dtypeof(v2), "Vec2", "Vec2::dot, v2 is not a Vec2");
            // </debug>
        ...
        */
         ...
         */
        divide : function (b) {
            assert.equal(__dtypeof(b), "Vec2", "b is not a Vec2");
         ...
         */
        min : function (b) {
            assert.equal(__dtypeof(b), "Vec2", "Vec2::min, b is not a Vec2");
         ...
         */
        max : function (b) {
            assert.equal(__dtypeof(b), "Vec2", "Vec2::max, b is not a Vec2");
